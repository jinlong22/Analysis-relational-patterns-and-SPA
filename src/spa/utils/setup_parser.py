...
from spa import lit_model
from spa import data
def setup_parser():
    ...
    # parser.add_argument('--regularization_two', '-r', default=0.0, type=float)
    ...
    parser.add_argument('--save_config', default=True, action='store_true', help='Save paramters config file.')
    ...
    parser.add_argument('--lambda_sym', default=0, type=float, help='the weight of the sym')

    parser.add_argument('--use_inv_weight', default=False, action='store_true')
    parser.add_argument('--lambda_inv', default=0, type=float, help='the weight of the inv')

    parser.add_argument('--use_sub_weight', default=False, action='store_true')
    parser.add_argument('--lambda_sub', default=0, type=float, help='the weight of the sub')

    parser.add_argument('--use_comp2_weight', default=False, action='store_true')
    parser.add_argument('--lambda_comp2', default=0, type=float, help='the weight of the comp2')

    parser.add_argument('--use_comp3_weight', default=False, action='store_true')
    parser.add_argument('--lambda_comp3', default=0, type=float, help='the weight of the comp3')
